...
router.get(
  ...
  (req, res, next) => {
    ...
    const products = adminData.products;
      ...
      res.render('shop', {prods: products, pageTitle: 'Shop', path: '/',  ////.render() --> É UM MÉTODO PROVIDENCIADO PELO EXPRESSJS, e que vai 'USE THE DEFAULT TEMPLATING ENGINE', a engine que definimos em 'app.set('view engine', 'pug')'... 
      productCSS: true,
      activeShop: true,
      hasProducts: products.length > 0});   ////hasProducts, essa propriedade que FAZ UM CHECK pela existência de alguma coisa dentro do array de 'products', SERÁ APENAS USADA NA VERSÃO DE NOSSO PROJETO QUE USA A TEMPLATING ENGINE DO 'handlebars', devido a SUAS LIMITAÇÕES (ver aula 'convertendo nosso projeto em handlebars')... 
      ...
      ///VAI RENDERIZAR O ARQUIVO 'shop.pug' LÁ NO FOLDER 'views', tudo graças aos códigos 'app.set()' que definimos LÁ EM 'app.js'..
              ...
              ///essa data que queremos USAR NO NOSSO TEMPLATE___ DEVE SER MAPPEADA A UM KEYNAME... (nesse caso usamos 'products' mesmo..)
            }
);
