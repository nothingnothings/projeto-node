...
// router.post('/create-checkout-session', authCheckerAndRedirecter, shopController.orderPost);




// router.post('/create-order', authCheckerAndRedirecter, shopController.orderPost); /////VOCÊ DEVE TRANSPLANTAR ESSE NEGÓCIO LÁ EM 'app.js', DIRETAMENTE, E ACIMA DE SUAS ROUTES.... ('app.post(/create-order)'...)
