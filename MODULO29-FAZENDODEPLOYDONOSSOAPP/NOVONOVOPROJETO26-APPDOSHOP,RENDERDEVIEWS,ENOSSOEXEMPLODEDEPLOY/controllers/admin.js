...
const debug = require('debug')('admin'); //melhor console.logging de seu projeto....
...
exports.editProduct = (req, res, next) => {
  ...
  if (validationErrors.length > 0) {
    ...
    Product.findById(productId) //método MONGOOSE, builtin...
      ...
      .catch((err) => {
        //////// O __ ERRO__ DO 'throw new Error('Dummy')' (_ E QUALQUER OUTRO ERROR DESSE TIPO, do tipo que 'THROWS AN ERROR') É __ CAPTURADO AQUI....  e armazenado nessa variável 'err', que então PASSAMOS AO CALL DE 'next()" LOGO ABAIXO, PARA __CONSEGUIR __ TRIGGAR O 'SPECIAL ERROR HANDLING MIDDLEWARE', lá no app.js...
        // console.log(err);
...
// exports.postDeleteProduct = (req, res, next) => { //não usa async requests..
