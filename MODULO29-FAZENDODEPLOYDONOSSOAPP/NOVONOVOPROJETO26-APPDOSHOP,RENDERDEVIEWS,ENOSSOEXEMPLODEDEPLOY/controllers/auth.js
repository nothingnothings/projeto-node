...
const debug = require('debug')('auth'); //melhor console.logging de seu projeto....
...
exports.getLoginPage = (req, res, next) => {
  ...
  // console.log(req.get('Cookie').trim().split('=')[1]); //manipulaç ão do COOKIE QUE NOS INTERESSA... código meio subóptimo.
