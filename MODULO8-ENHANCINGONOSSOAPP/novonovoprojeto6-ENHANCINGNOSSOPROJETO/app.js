...
///1o parâmetro = 'nome da propriedade em 'set' ' ,  2o parÂmetro --> VALOR dessa propriedade/variável usada como valor nessa propriedade....
// app.set('view engine', 'pug'); ///CÓDIGO NECESSÁRIO PARA IMPLEMENTAR/UTILIZAR TEMPLATING ENGINE (no caso, 'pug'...)
// app.set('views', 'views'); //////// AQUI, no SEGUNDO parâmtero, DIZEMOS O LUGAR EM QUE DEVERÃO SER ENCONTRADAS NOSSAS VIEWS (representadas PELO PRIMEIRO PARÂMETRO, QUE É A 'property' dentro do objeto que alteraremos por meio de '.set()'...)....  (nós já nomeamos um folder como 'views' no nosos projeto para não ter que alteraer esse default, ainda assim,  o professor vai definir esse CONFIG EXPLICITAMENTE,  só para mostrar/nos lembrar que ISSO É POSSÍVEL, QUE É UMA OPÇÃO....
////setup do PUG.




////VERSÃO DE IMPORT/install/implementação DO __HANDLEBARS__ (templating engine RIVAL DO PUG....)
...
app.use(
  ...
  '/admin', //será APLICADO NA URL de nosso path, do path desse negócio aí... (que está lá em 'admin.js')...
    ...
    // adminData.routes   ////uso do EXPRESSJS...
